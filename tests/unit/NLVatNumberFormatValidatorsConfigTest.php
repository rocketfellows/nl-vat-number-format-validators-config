...
namespace rocketfellows\NLVatNumberFormatValidatorsConfig\tests\unit;
...
use rocketfellows\NLVatNumberFormatValidatorsConfig\NLVatNumberFormatValidatorsConfig;

class NLVatNumberFormatValidatorsConfigTest extends TestCase
{
    private const TESTING_CONFIG_CLASS = NLVatNumberFormatValidatorsConfig::class;
    private const EXPECTED_CONFIG_DEFAULT_VALIDATOR_CLASS = NLVatFormatValidator::class;
    ...
    {
        $this->assertEquals(ISO3166::NL(), $config->getCountry());
    }
